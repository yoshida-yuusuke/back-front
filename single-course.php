    ...
    <div class="course-wrap">
      ...
      <!-------------------------------
        ...
        <?php for ($i = 1; $i < 7; $i++) {
          ...
          <section class="course-1" id="course-<?php echo $i; ?>">
              <div class="course-title-wrap">
                <p class="course-number-sp"><?php echo $i; //(SP限定)丸数字 ?></p>
                <p class="">
                  <?php echo get_field('catchphrase'.$i); //(SP限定)場所ごとのキャッチフレーズ ?>
                </p>
              </div>
              <div class="location-flex"><!--★★★-->
                  <img class="course-img" src="<?php echo $url ?>" alt="<?php the_field('location-name' . $i); ?>" />
                  <div class="course-txt-wrap course-txt-wrap-<?php echo $clsnum; ?>">
                      <p class="course-number-pc"><?php echo $i; //(PC限定)数字 ?></p>
                      <div class="course-txt-group">
                          <h3 class="course-spot-name"><?php the_field('location-name' . $i); //場所名 ?></h3>
                          <p class="course-txt">
            ...
            <!---------- 移動アイコン ここから ------------>
              <div class="move-icon-wrap">
                  ...
                  // sp版の矢印＋乗り物アイコン
                  if ( $access != 'goal') : ?>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/model/<?php echo $access;?>_arrow_sp<?php echo $num;?>.png" alt="矢印" class="move-icon-arrow-sp">
                  <?php else : ?>
                  <?php endif; ?>
